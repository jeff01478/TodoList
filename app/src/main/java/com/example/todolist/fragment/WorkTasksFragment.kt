...
class WorkTasksFragment(fragmentActivity: FragmentActivity) : Fragment(), TaskUpdateListener {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_work_tasks, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        listView?.setOnItemClickListener { _, _, position, _ ->
            val task = if (GlobalVariable.searchMod) {
                ...
                GlobalVariable.workTaskList[position]
            }
