...
class PersonalTasksFragment(fragmentActivity: FragmentActivity) : Fragment(), TaskUpdateListener {
    ...
    private var adapter = TaskAdapter(fragmentActivity,
        R.layout.task_item,
        GlobalVariable.personalTaskList
    )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_personal_tasks, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        listView?.setOnItemClickListener { _, _, position, _ ->
            val task = if (GlobalVariable.searchMod) {
                ...
                GlobalVariable.personalTaskList[position]
            }
